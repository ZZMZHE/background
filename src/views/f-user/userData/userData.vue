<template>
    <div class="userData">
           ...
           <div class="searchBox">
                <el-form :inline="true" :model="formInline" class="demo-form-inline" size="small">
                    ...
                    <el-form-item label="状态" prop="status">
                     ...
                     <el-form-item label="消费类型" prop="status">
                        <el-select v-model="formInline.status" placeholder="请选择" style="width: 150px">
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <span class="color margin" style="color: #FE093C" @click="openDia(scope.row.id, scope.row.remark)">备注</span>
                        </template>
                    </el-table-column>
                </el-table>
                <div class="paging">
       ...
       <div class="dialog">
           <el-dialog title="编辑备注" :visible.sync="dialogFormVisible" width="30%">
                <el-form :model="form">
                    <el-form-item label="备注" :label-width="formLabelWidth" :required="true">
                        <el-input
                            type="textarea"
                            placeholder="请输入备注内容"
                            v-model="form.remark"
...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            userUpdateRemark(``, { id: this.id, remark: this.form.remark }).then(res => {
                if (res.status === 200) {
        ...
        stopLogin(i, s) {
            ...
            this.$confirm(`是否将此用户${txt}登录？`, '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(() => {
                userUpdateStatus(``, { id: i, status: s }).then(res => {
                    if (res.status === 200) {
                        this.$message({
                            type: 'success',
                            message: '操作成功!'
