...
import { courseCommentList, courseCommentUpdate, courseCommentDelete } from 'api/index.js'
...
export default {
    ...
    methods: {
        // 获取数据
        getData() {
            let score = this.formInline.score || null
            courseCommentList(``, {
                id: this.id,
        ...
        del(val) {
            this.$confirm('此操作将删除该评论, 是否继续?', '提示', {
                ...
                courseCommentDelete(``, { id: val.id }).then(res => {
                    if (res) {
        ...
        // 去详情
        goDetails(val) {
            this.$router.push({ name: 'courseTalkDetails', query: val })
        },
        goBack() {
