                ...
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item label="主图" :required="true">
                        <el-upload
                            ...
                            <i v-if="form.coverUrl" class="tihuan">点击替换</i>
                            <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                        </el-upload>
                        <span style="color: red">建议上传375*667尺寸大小的图片</span>
                    </el-form-item>
                </el-form>
            </div>
        </div>
...
<script>
import { cmsLoginImgUpdate, cmsLoginImgInfo } from 'api/index.js'
