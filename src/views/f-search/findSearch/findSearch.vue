...
<script>
import { cmsKeywordDiscoverList, cmsKeywordDiscoverAdd, cmsKeywordDiscoverDel } from 'api/index.js'
export default {
    name: 'findSearch',
    components: {},
    data() {
    ...
    methods: {
        // 获取数据
        getData(val) {
            cmsKeywordDiscoverList().then(res => {
                if (res.status === 200) {
