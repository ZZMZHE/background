            ...
            <div class="formBox">
                <el-form ref="form" :model="form" label-width="90px">
                    ...
                    <el-form-item label="banner图" :required="true">
                        ...
                        <span style="color: red">建议上传750*898尺寸大小的图片</span>
                    </el-form-item>
...
<script>
import { cmsBannerDiscoverHeadAdd, cmsBannerDiscoverHeadInfo } from 'api/index.js'
...
export default {
    ...
    computed: {
        uploadUrl() {
            return this.$store.state.uploadUrl + '64'
        }
    },
    watch: {},
    methods: {
        getData() {
            cmsBannerDiscoverHeadInfo(``, {
                id: this.id
            }).then(res => {
                if (res.status === 200) {
        ...
        // 返回上一页
        goBack() {
            this.$router.push({ name: 'findBanner' })
        }
    },
    created() {
