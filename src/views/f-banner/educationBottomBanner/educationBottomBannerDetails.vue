<template>
    <div class="educationBottomBannerDetails">
        <div class="conn">
            <div class="header">
            ...
            <div class="formBox">
                <el-form ref="form" :model="form" label-width="90px">
                    ...
                    <el-form-item label="banner图" :required="true">
                        ...
                        <span style="color: red">建议上传690*180尺寸大小的图片</span>
                    </el-form-item>
...
<script>
import { cmsBannerEduCentreAdd, cmsBannerEduCentreInfo } from 'api/index.js'
export default {
    ...
    computed: {
        uploadUrl() {
            return this.$store.state.uploadUrl + '62'
        }
    },
    watch: {},
    methods: {
        getData() {
            cmsBannerEduCentreInfo(``, {
                id: this.id
            }).then(res => {
                if (res.status === 200) {
        ...
        // 返回上一页
        goBack() {
            this.$router.push({ name: 'educationBottomBanner' })
        }
    },
    created() {
