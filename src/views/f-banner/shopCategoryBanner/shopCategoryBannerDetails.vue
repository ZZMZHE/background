<template>
    <div class="shopCategoryBannerDetails">
        <div class="conn">
            <div class="header">
            ...
            <div class="formBox">
                <el-form ref="form" :model="form" label-width="90px">
                    ...
                    <el-form-item label="banner图" :required="true">
                        ...
                        <span style="color: red">建议上传494*160尺寸大小的图片</span>
                    </el-form-item>
                    <el-form-item label="详情类别" prop="type" :required="true">
                        <el-select v-model="form.type" placeholder="请选择城市">
...
<script>
import { cmsBannerMallCategoryAdd, cmsBannerMallCategoryInfo } from 'api/index.js'
export default {
    ...
    computed: {
        uploadUrl() {
            return this.$store.state.uploadUrl + '66'
        }
    },
    watch: {},
    methods: {
        getData() {
            cmsBannerMallCategoryInfo(``, {
                id: this.id
            }).then(res => {
                if (res.status === 200) {
        ...
        // 返回上一页
        goBack() {
            this.$router.push({ name: 'shopCategoryBanner' })
        }
    },
    created() {
