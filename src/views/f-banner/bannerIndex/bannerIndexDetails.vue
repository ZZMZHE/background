            ...
            <div class="formBox">
                <el-form ref="form" :model="form" label-width="90px">
                    ...
                    <el-form-item label="banner图" :required="true">
                        ...
                        <span style="color: red">建议上传690*281尺寸大小的图片</span>
                    </el-form-item>
...
<script>
import { cmsBannerHomeHeadAdd, cmsBannerHomeHeadInfo } from 'api/index.js'
export default {
