            ...
            <div class="formBox">
                <el-form ref="form" :model="form" label-width="90px">
                    ...
                    <el-form-item label="banner图" :required="true">
                        ...
                        <span style="color: red">建议上传750*474尺寸大小的图片</span>
                    </el-form-item>
...
<script>
import { cmsBannerMallHeadAdd, cmsBannerMallHeadInfo } from 'api/index.js'
export default {
    ...
    methods: {
        ...
        // 返回上一页
        goBack() {
            this.$router.push({ name: 'shopBanner' })
        }
    },
    created() {
