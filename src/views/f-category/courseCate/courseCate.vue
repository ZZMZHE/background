...
<script>
import { eduCourseCategoryList, eduCourseCategoryAdd, eduCourseCategoryDel } from 'api/index.js'
export default {
    name: 'courseCate',
    components: {},
    data() {
    ...
    methods: {
        ...
        // 点击查看
        goDetails(val) {
            this.$router.push({ name: 'courseCateDetails', query: val })
        }
    },
    created() {
        this.getData()
